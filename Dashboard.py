...
if escolha == "Página Inicial":
    ...
    * **Hospedagem do Cliente:** Grande parte ainda utiliza ON PREMISES (40.67%) ou não tem a informação disponível (53.6%), o que representa uma grande oportunidade para a migração para a nuvem.
    ...
    st.markdown("<h2>Para segmentar os clientes, utilizamos um modelo de clusterização, que agrupa automaticamente clientes com características semelhantes. Testamos duas abordagens principais:</h2>", unsafe_allow_html=True)
    st.markdown("""        
